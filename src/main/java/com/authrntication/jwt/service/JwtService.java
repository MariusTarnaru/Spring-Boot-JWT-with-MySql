...
import com.authrntication.jwt.Util.JwtUtil;
import com.authrntication.jwt.dao.UserDao;
import com.authrntication.jwt.entity.JwtRequest;
import com.authrntication.jwt.entity.JwtResponse;
...
public class JwtService implements UserDetailsService {
    ...
    public JwtResponse createJwtToken(JwtRequest jwtRequest) throws Exception {
       ...
       String newJwtGeneratedToken = jwtUtil.generateToken(userDetails);

       User user = userDao.findById(userName).get();
       return new JwtResponse(user, newJwtGeneratedToken);
